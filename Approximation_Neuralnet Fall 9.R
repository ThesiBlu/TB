...
dat1 <- data.frame(b1,f_1(b1))
names(dat1) <- c("x1","y1")

dat2 <- data.frame(b1,f_2(b1))
names(dat2) <- c("x2","y2")

dat3 <- data.frame(b1,f_3(b1))
names(dat3) <- c("x3","y3")

dat4 <- data.frame(b1,f_4(b1))
names(dat4) <- c("x4","y4")

dat5 <- data.frame(b1,f_5(b1))
names(dat5) <- c("x5","y5")

dat6 <- data.frame(b1,f_6(b1))
names(dat6) <- c("x6", "y6")
...
nn1 <- neuralnet(y1 ~ x1, data = dat1, hidden = c(2,2), rep=1, stepmax = 1e+07)
plot(nn1)

nn2 <- neuralnet(y2 ~ x2, data = dat2, hidden = c(2,2), rep=1, stepmax = 1e+07)
plot(nn2)

nn3 <- neuralnet(y3 ~ x3, data = dat3, hidden = c(2,2), rep=1, stepmax = 1e+07)
plot(nn3)

nn4 <- neuralnet(y4 ~ x4, data = dat4, hidden = c(2,2), rep=1, stepmax = 1e+07)
plot(nn4)
...
fall9_matrix <-  cbind(nn1$result.matrix,nn2$result.matrix,nn3$result.matrix,nn4$result.matrix,nn5$result.matrix,nn6$result.matrix)

#Fehlertabelle
Error <- fall9_matrix[1,]
