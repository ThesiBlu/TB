...
#Error: Stepmax bei nn5
nn5$result.matrix[1,1] <- 0
nn5$result.matrix[2,1] <- 0
nn5$result.matrix[3,1] <- 999999
...
fall6_matrix <-  cbind(nn1$result.matrix,nn2$result.matrix,nn3$result.matrix,nn4$result.matrix,nn5$result.matrix,nn6$result.matrix)

#Fehlertabelle
Error <- fall6_matrix[1,]
