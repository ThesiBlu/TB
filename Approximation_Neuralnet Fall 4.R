...
points(dat1[,1], y = nn1$response, col="blue", lty=2, pch=16, cex= 0.5)
...
points(dat2[,1], y = nn2$response, col="blue", lty = 2, pch = 16, cex=0.5)
legend("topright", legend=c("true","nn"), lty=c(1,1), col=c("red","blue"))
...
points(dat3[,1], y = nn3$response, col="blue", lty=2, pch = 16, cex = 0.5)
legend("topright", legend=c("true","nn"), lty=c(1,1), col=c("red","blue"))
...
points(dat4[,1], y = nn4$response, col="blue", lty=2, pch = 16, cex = 0.5)
legend("topright", legend=c("true","nn"), lty=c(1,1), col=c("red","blue"))
...
points(dat5[,1], y = nn5$response, col="blue", lty=2, pch = 16, cex = 0.5)
legend("topright", legend=c("true","nn"), lty=c(1,1), col=c("red","blue"))
...
points(dat6[,1], y = nn6$response, col="blue", lty=2, pch = 16, cex = 0.5)
legend("topright", legend=c("true","nn"), lty=c(1,1), col=c("red","blue"))
legend("topleft", legend=paste0("Error: ", e_6),border="white")

#Gesamtergebis-Matrix
fall4_matrix <-  cbind(nn1$result.matrix,nn2$result.matrix,nn3$result.matrix,nn4$result.matrix,nn5$result.matrix,nn6$result.matrix)

#Fehlertabelle
Error <- fall4_matrix[1,]
